...
remove_columns_from_csv('D:\Dev\Python/footballElo\original_databases\Global football results for domestic leagues from 1993 to 2024/football_results.csv', 'football_results_modified.csv', columns_to_remove)
